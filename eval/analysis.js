...
Wasabi.analysis = {
  ...
  br_if(location, conditionalTarget, condition) {
    console.log(
      location,
      "br_if, (conditionally) to label",
      conditionalTarget.label,
      "(==",
      conditionalTarget.location,
      "), condition =",
      condition
    );
  },
  ...
  call_pre(location, targetFunc, args, indirectTableIdx) {
    console.log(
      location,
      indirectTableIdx === undefined ? "direct" : "indirect",
      "call",
      "to func #",
      targetFunc,
      "args =",
  ...
  return_(location, values) {
    console.log(
      location,
      location.instr === -1 ? "implicit" : "explicit",
      "return, values = ",
      values
    );
  },
